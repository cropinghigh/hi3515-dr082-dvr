...
void M_DrawSound(void)
{
    ...
    // printf("X: %d Y:%d LINEHEIGHT:%d SFXVOL:%d TOTALY:%d SNDSFVOL:%d\n", SoundDef.x, SoundDef.y, LINEHEIGHT, sfx_vol, SoundDef.y+LINEHEIGHT*(sfx_vol+1), snd_SfxVolume);

    M_DrawThermo(SoundDef.x,SoundDef.y+LINEHEIGHT*(sfx_vol+1),
		 16,snd_SfxVolume);
    
    // printf("X: %d Y:%d LINEHEIGHT:%d SFXVOL:%d TOTALY:%d SNDSFVOL:%d\n", SoundDef.x, SoundDef.y, LINEHEIGHT, music_vol, SoundDef.y+LINEHEIGHT*(music_vol+1), snd_MusicVolume);
