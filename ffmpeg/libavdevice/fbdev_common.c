...
enum AVPixelFormat ff_get_pixfmt_from_fb_varinfo(struct fb_var_screeninfo *varinfo)
{
    ...
    av_log(NULL, AV_LOG_ERROR, "Wrong fb pixformat: %d %d %d %d\n", varinfo->bits_per_pixel, varinfo->red.offset, varinfo->green.offset, varinfo->blue.offset);
